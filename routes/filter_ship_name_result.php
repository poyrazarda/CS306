...
$shipfirm2 = $_POST['firm_name2']; 


echo "<h3>Shippers with firm's name: " . $shipfirm2 ."</h3>";
...
if($shipfirm2 == $shipper_name) 
{
    
    echo "<html>";
    echo "<ul class='list-group list-group-horizontal'>";
    echo "<li class='list-group-item' style='width: 120px'> $shipper_id </li>";
    echo "<li class='list-group-item' style='width: 200px; background-color: pink;'> $shipper_name </li>";
    echo "<li class='list-group-item' style='width: 230px'> $shipper_mail </li>";
    echo "</ul>";
    echo "</html>";
}
} 
echo "<div class='container' style='height: 25px;'>";
    ...
    echo "</form>";
    echo "<form action='/ecommerce/filter_ship_choice.html' method='get'>";
    echo "<button type='submit' class='btn btn-dark' formaction='/ecommerce/filter_ship_choice.html'>Filter again</button>";
    echo "</form>";
