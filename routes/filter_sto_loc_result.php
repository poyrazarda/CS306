...
$stoloc2 = $_POST['sto_loc2']; 


echo "<h3>Storages in location: " . $stoloc2 ."</h3>";
...
echo "<html>";
                        ...
                        echo "<li class='list-group-item' style='width: 200px; background-color: pink;'> Location </li>";
...
if($stoloc2 == $storage_location) 
{
    
    echo "<html>";
    echo "<ul class='list-group list-group-horizontal'>";
    echo "<li class='list-group-item' style='width: 120px'> $storage_id </li>";
    echo "<li class='list-group-item' style='width: 200px; background-color: pink;'> $storage_location </li>";
