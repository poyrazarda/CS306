...
$shipid2 = $_POST['firm_id2']; 


echo "<h3>Shippers with ID: " . $shipid2 ."</h3>";
...
if($shipid2 == $shipper_id) 
{
    
    echo "<html>";
    echo "<ul class='list-group list-group-horizontal'>";
    echo "<li class='list-group-item' style='width: 120px; background-color: pink;'> $shipper_id </li>";
