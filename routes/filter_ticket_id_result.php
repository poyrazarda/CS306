...
<div class="container center" style="width: 350px">
...
$ticketid2 = $_POST['ticket_id2']; 


echo "<h3>Ticket types with ID: " . $ticketid2 ."</h3>";
...
if($ticketid2 == $ticket_id) 
{
    
    echo "<html>";
    echo "<ul class='list-group list-group-horizontal'>";
    echo "<li class='list-group-item' style='width: 120px; background-color: pink;'> $ticket_id </li>";
...
echo "<div class='container' style='height: 25px;'>";
    ...
    echo "</form>";
    echo "<form action='/ecommerce/filter_ticket_choice.html' method='get'>";
    echo "<button type='submit' class='btn btn-dark' formaction='/ecommerce/filter_ticket_choice.html'>Filter again</button>";
    echo "</form>";
