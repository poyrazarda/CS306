...
$payid2 = $_POST['pay_id2']; 


echo "<h3>Payment types with ID: " . $payid2 ."</h3>";
...
if($payid2 == $payment_id) 
{
    
    echo "<html>";
                        echo "<ul class='list-group list-group-horizontal'>";
                        echo "<li class='list-group-item' style='width: 120px; background-color: pink;'> $payment_id </li>";
...
echo "<div class='container' style='height: 25px;'>";
    ...
    echo "</form>";
    echo "<form action='/ecommerce/filter_pay_choice.html' method='get'>";
    echo "<button type='submit' class='btn btn-dark' formaction='/ecommerce/filter_pay_choice.html'>Filter again</button>";
    echo "</form>";
