...
$suppfirm2 = $_POST['firm_name2']; 


echo "<h3>Suppliers with firm's name: " . $suppfirm2 ."</h3>";
...
if($suppfirm2 == $supplier_name) 
{
    
    echo "<html>";
    echo "<ul class='list-group list-group-horizontal'>";
    echo "<li class='list-group-item' style='width: 120px'> $supplier_id </li>";
    echo "<li class='list-group-item' style='width: 200px; background-color: pink;'> $supplier_name </li>";
...
echo "<div class='container' style='height: 25px;'>";
    ...
    echo "</form>";
    echo "<form action='/ecommerce/filter_supp_choice.html' method='get'>";
    echo "<button type='submit' class='btn btn-dark' formaction='/ecommerce/filter_supp_choice.html'>Filter again</button>";
    echo "</form>";
