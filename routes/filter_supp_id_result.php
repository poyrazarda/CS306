...
$suppid2 = $_POST['supp_id2']; 


echo "<h3>Suppliers with ID: " . $suppid2 ."</h3>";
...
if($suppid2 == $supplier_id) 
{
    
    echo "<html>";
    echo "<ul class='list-group list-group-horizontal'>";
    echo "<li class='list-group-item' style='width: 120px; background-color: pink;'> $supplier_id </li>";
