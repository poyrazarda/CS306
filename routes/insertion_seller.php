...
if (!empty($_POST['seller_id'])){ 
    ...
    $sellerbudget = $_POST['budget']; 
    $sellermail = $_POST['mail']; 
    
    $sql_statement = "INSERT INTO sellers(seller_id, name, budget, mail) VALUES ($sellerid,'$sellername',$sellerbudget,'$sellermail')"; 

    $result = mysqli_query($db, $sql_statement);
    echo "<div class='card' style='width: 770px'>";
    echo "<div class='card-body'>";
    echo $sellername . " with ID: " . $sellerid . " is successfully inserted.";
    echo "</div>";
    echo "</div>";
    ...
    echo "</form>";
    echo "<form action='/ecommerce/insertion_seller.html' method='get'>";
    echo "<button type='submit' class='btn btn-info' formaction='/ecommerce/insertion_seller.html'>Insert Again</button>";
    echo "</form>";
} 
else 
{
    echo "You did not enter seller id." . "<br>";
    echo "To go back and give proper values:";
    echo "<form action='/ecommerce/insertion_seller.html method='get'>";
    echo "<button type='submit' class='btn btn-success' formaction='/ecommerce/insertion_seller.html'>Go to Insertion page</button>";
    echo "</form>";
}
?>
...
if (!empty($_POST['seller_id']))
{
  echo "<h1>Seller list with added one.</h1>";
                      ...
                      { // Iterating the result
                       ...
                       if($seller_id == $sellerid)
                       {
                        ...
                        echo "<li class='list-group-item' style='width: 200px; background-color: pink;'> $seller_name </li>";
                        echo "<li class='list-group-item' style='width: 200px; background-color: pink;'> $seller_budget </li>";
                        echo "<li class='list-group-item' style='width: 250px; background-color: pink;'> $seller_mail </li>";
                        echo "</ul>";
                        echo "</html>";
                       }
                       else
