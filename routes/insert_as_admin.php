...
<div class="row">
    <div class="container center" style="width: 400px">
        <form action="insertadmin.php" method="POST">
            <div class="mb-3">
              <label for="adminmessage" class="form-label">Your message</label>
              <textarea class="form-control" id="exampleFormControlTextarea1" name="message_admin" rows="3"></textarea>
