...
{
    $shipid = $_POST['ids'];
    $sql_statement = "DELETE FROM shipper WHERE shipper_id = $shipid";
    $result = mysqli_query($db, $sql_statement);
   
    echo "<div class='card' style='width: 520px'>";
    echo "<div class='card-body'>";
    echo "Shipper with ID: ". $shipid . " is successfully deleted.";
    echo "</div>";
    echo "</div>";
    ...
    echo "</form>";
    echo "<form action='/ecommerce/deletion_ship_select.php' method='get'>";
    echo "<button type='submit' class='btn btn-warning' formaction='/ecommerce/deletion_ship_select.php'>Delete Again</button>";
    echo "</form>";
}

?>

<h1>Shipper list without deleted one.</h1>
<?php
