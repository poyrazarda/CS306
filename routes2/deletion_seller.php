...
{
    $sellerid = $_POST['ids'];
    $sql_statement = "DELETE FROM sellers WHERE seller_id = $sellerid";
    $result = mysqli_query($db, $sql_statement);
   
    echo "<div class='card' style='width: 770px'>";
    echo "<div class='card-body'>";
    echo "Seller with ID: ". $sellerid . " is successfully deleted.";
    echo "</div>";
    echo "</div>";
    ...
    echo "</form>";
    echo "<form action='/ecommerce/deletion_seller_select.php' method='get'>";
    echo "<button type='submit' class='btn btn-warning' formaction='/ecommerce/deletion_seller_select.php'>Delete Again</button>";
    echo "</form>";
}

?>

<h1>Seller list without deleted one.</h1>
<?php
