...
<div class = "container center" style="width: 550px">
     <h2>Delete Ticket Type</h2>
     <div id="idHelp" class="form-text">Below you see the id and category of the ticket. Choose one of them to delete.</div>
...
<form action ="./deletion_ticket.php" method="POST">
<select name="ids">


<?php

$sql_command = "SELECT ticket_id, category FROM support";

$myresult = mysqli_query($db, $sql_command);

    while($id_rows = mysqli_fetch_assoc($myresult))
    {
        $ticketid = $id_rows['ticket_id'];
        $ticketcat = $id_rows['category'];
        
        echo "<option value=$ticketid>". $ticketid . " - " . $ticketcat . "</option>";
