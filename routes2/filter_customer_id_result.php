...
$customerid2 = $_POST['customer_id2']; 


echo "<h3>Customers with ID: " . $customerid2 ."</h3>";
...
if($customerid2 == $customer_id) 
{
    
  echo "<html>";
  echo "<ul class='list-group list-group-horizontal'>";
  echo "<li class='list-group-item' style='width: 120px; background-color: pink;'> $customer_id </li>";
