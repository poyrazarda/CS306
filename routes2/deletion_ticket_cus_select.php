...
<div class = "container center" style="width: 550px">
     <h2>Delete Ticket Message</h2>
     <div id="idHelp" class="form-text">Below you see the id and message of the ticket. Choose one of them to delete.</div>
...
<form action ="./deletion_ticket_cus.php" method="POST">
<select name="ids">


<?php

$sql_command = "SELECT sup_id, message FROM ticket_cus";

$myresult = mysqli_query($db, $sql_command);

    while($id_rows = mysqli_fetch_assoc($myresult))
    {
        $supid = $id_rows['sup_id'];
        $supmes = $id_rows['message'];
        
        echo "<option value=$supid>". $supid . " - " . $supmes . "</option>";
