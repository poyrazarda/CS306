...
<div class = "container center" style="width: 550px">
     <h2>Delete Seller</h2>
     <div id="idHelp" class="form-text">Below you see the id and name of the seller. Choose one of them to delete.</div>
...
<form action ="./deletion_seller.php" method="POST">
<select name="ids">


<?php

$sql_command = "SELECT seller_id, name FROM sellers";

$myresult = mysqli_query($db, $sql_command);

    while($id_rows = mysqli_fetch_assoc($myresult))
    {
        $sellerid = $id_rows['seller_id'];
        $sellername = $id_rows['name'];
        
        echo "<option value=$sellerid>". $sellerid . " - " . $sellername . "</option>";
