...
{
    $pid2 = $_POST['ids'];
    $sql_statement = "DELETE FROM pro_sto WHERE product_id = $pid2";
    $result = mysqli_query($db, $sql_statement);
   
    echo "<div class='card' style='width: 520px'>";
    echo "<div class='card-body'>";
    echo "Product with ID: ". $pid2. " is successfully deleted from the storage.";
    echo "</div>";
    echo "</div>";
    ...
    echo "</form>";
    echo "<form action='/ecommerce/deletion_prosto_select.php' method='get'>";
    echo "<button type='submit' class='btn btn-warning' formaction='/ecommerce/deletion_prosto_select.php'>Delete Again</button>";
    echo "</form>";
}

?>

<h1>Products-Storage list without deleted one.</h1>
<?php
