...
if(!empty($_POST['ids']))
{
    ...
    $sql_statement = "DELETE FROM customer WHERE customer_id = $customerid";
    $result = mysqli_query($db, $sql_statement);
   
    echo "<div class='card' style='width: 1270px'>";
    echo "<div class='card-body'>";
    echo "Customer with ID: ". $customerid . " is successfully deleted.";
    echo "</div>";
    echo "</div>";
    ...
    echo "</form>";
    echo "<form action='/ecommerce/deletion_customer_select.php' method='get'>";
    echo "<button type='submit' class='btn btn-warning' formaction='/ecommerce/deletion_customer_select.php'>Delete Again</button>";
    echo "</form>";
}

?>

<h1>Customer list without deleted one.</h1>
<?php
