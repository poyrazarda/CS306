...
<div class = "container center" style="width: 550px">
     ...
     <div id="idHelp" class="form-text">Below you see the id and name of the product. Choose one of them to delete.</div>
...
<form action ="./deletion_prod.php" method="POST">
<select name="ids">


<?php

$sql_command = "SELECT prod_id, name, price FROM products";

$myresult = mysqli_query($db, $sql_command);

    while($id_rows = mysqli_fetch_assoc($myresult))
    {
        $prodid = $id_rows['prod_id'];
        $prodname = $id_rows['name'];
        $prodprice = $id_rows['price'];
        
        echo "<option value=$prodid>". $prodid . " - " . $prodname . "</option>";
