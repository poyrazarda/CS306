...
{
    $suppid = $_POST['ids'];
    $sql_statement = "DELETE FROM supplier WHERE supp_id = $suppid";
    $result = mysqli_query($db, $sql_statement);
   
    echo "<div class='card' style='width: 550px'>";
    echo "<div class='card-body'>";
    echo "Supplier with ID: ". $suppid . " is successfully deleted.";
    echo "</div>";
    echo "</div>";
    ...
    echo "</form>";
    echo "<form action='/ecommerce/deletion_supp_select.php' method='get'>";
    echo "<button type='submit' class='btn btn-warning' formaction='/ecommerce/deletion_supp_select.php'>Delete Again</button>";
    echo "</form>";
}

?>

<h1>Supplier list without deleted one.</h1>
<?php
