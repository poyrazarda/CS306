...
<div class = "container center" style="width: 550px">
     ...
     <div id="idHelp" class="form-text">Below you see the id and amount of the the payment. Choose one of them to delete.</div>
...
<form action ="./deletion_make.php" method="POST">
<select name="ids">


<?php

$sql_command = "SELECT payment_id, amount FROM make_payment";
...
$myresult = mysqli_query($db, $sql_command);
    ...
    while($id_rows = mysqli_fetch_assoc($myresult))
    {
        ...
        $payment_id2= $id_rows['payment_id']; 
        $amount2 = $id_rows['amount']; 
        
        echo "<option value=$payment_id2>". $payment_id2 . " - " . $amount2 . "</option>";
