...
{
    $storageid = $_POST['ids'];
    $sql_statement = "DELETE FROM storage WHERE storage_id = $storageid";
    $result = mysqli_query($db, $sql_statement);
   
    echo "<div class='card' style='width: 520px'>";
    echo "<div class='card-body'>";
    echo "Storage with ID: ". $storageid . " is successfully deleted.";
    echo "</div>";
    echo "</div>";
    ...
    echo "</form>";
    echo "<form action='/ecommerce/deletion_storage_select.php' method='get'>";
    echo "<button type='submit' class='btn btn-warning' formaction='/ecommerce/deletion_storage_select.php'>Delete Again</button>";
    echo "</form>";
}

?>

<h1>Storage list without deleted one.</h1>
<?php
