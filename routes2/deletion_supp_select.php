...
<div class = "container center" style="width: 550px">
     ...
     <div id="idHelp" class="form-text">Below you see the id and firm's name of the supplier. Choose one of them to delete.</div>
...
<form action ="./deletion_supp.php" method="POST">
<select name="ids">


<?php

$sql_command = "SELECT supp_id, firm FROM supplier";

$myresult = mysqli_query($db, $sql_command);

    while($id_rows = mysqli_fetch_assoc($myresult))
    {
        $suppid = $id_rows['supp_id'];
        $suppfirm = $id_rows['firm'];
        
        echo "<option value=$suppid>". $suppid . " - " . $suppfirm . "</option>";
