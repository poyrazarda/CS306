...
<div class = "container center" style="width: 550px">
     ...
     <div id="idHelp" class="form-text">Below you see the id and firm's name of the shipper. Choose one of them to delete.</div>
...
<form action ="./deletion_ship.php" method="POST">
<select name="ids">


<?php

$sql_command = "SELECT shipper_id, firm FROM shipper";

$myresult = mysqli_query($db, $sql_command);

    while($id_rows = mysqli_fetch_assoc($myresult))
    {
        $shipid = $id_rows['shipper_id'];
        $shipfirm = $id_rows['firm'];
        
        echo "<option value=$shipid>". $shipid . " - " . $shipfirm . "</option>";
