...
echo "<h3>Products between prices " . $minprice . "-" . $maxprice ."</h3>";
...
echo "<html>";
                        ...
                        echo "<li class='list-group-item' style='width: 90px; background-color: pink;'> Price </li>";
                        echo "</ul>";
                        echo "</html>";
...
if(($minprice <= $prodprice) and ($prodprice <= $maxprice)) 
{
    ...
    echo "<html>";
                        ...
                        echo "<li class='list-group-item' style='width: 90px; background-color: pink;'> $prodprice </li>";
                        echo "</ul>";
                        echo "</html>";
}
} 
