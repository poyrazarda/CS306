...
<div class = "container center" style="width: 550px">
     ...
     <div id="idHelp" class="form-text">Below you see the id and location of the storage. Choose one of them to delete.</div>
...
<form action ="./deletion_storage.php" method="POST">
<select name="ids">


<?php

$sql_command = "SELECT storage_id, location FROM storage";

$myresult = mysqli_query($db, $sql_command);

    while($id_rows = mysqli_fetch_assoc($myresult))
    {
        $storageid = $id_rows['storage_id'];
        $sto_location = $id_rows['location'];
        
        echo "<option value=$storageid>". $storageid . " - " . $sto_location . "</option>";
