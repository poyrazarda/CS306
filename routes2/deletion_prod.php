...
{
    $prodid = $_POST['ids'];
    $sql_statement = "DELETE FROM products WHERE prod_id = $prodid";
    $result = mysqli_query($db, $sql_statement);
   
    echo "<div class='card' style='width: 650px'>";
    echo "<div class='card-body'>";
    echo "Product with ID: ". $prodid . " is successfully deleted.";
    echo "</div>";
    echo "</div>";
    ...
    echo "</form>";
    echo "<form action='/ecommerce/deletion_prod_select.php' method='get'>";
    echo "<button type='submit' class='btn btn-warning' formaction='/ecommerce/deletion_prod_select.php'>Delete Again</button>";
    echo "</form>";
}

?>

<h1>Products list without deleted one.</h1>
<?php
