...
{
    $payid = $_POST['ids'];
    $sql_statement = "DELETE FROM payment WHERE payment_id = $payid";
    $result = mysqli_query($db, $sql_statement);
   
    echo "<div class='card' style='width: 370px'>";
    echo "<div class='card-body'>";
    echo "Payment Type with ID: ". $payid . " is successfully deleted.";
    echo "</div>";
    echo "</div>";
    ...
    echo "</form>";
    echo "<form action='/ecommerce/deletion_pay_select.php' method='get'>";
    echo "<button type='submit' class='btn btn-warning' formaction='/ecommerce/deletion_pay_select.php'>Delete Again</button>";
    echo "</form>";
}

?>

<h1>Payment categories without deleted one.</h1>
<?php
