...
<div class = "container center" style="width: 550px">
     <h2>Delete Order</h2>
     <div id="idHelp" class="form-text">Below you see the order ID. Choose one of them to delete.</div>
...
<form action ="./deletion_order.php" method="POST">
<select name="ids">


<?php

$sql_command = "SELECT order_id FROM product_order";

$myresult = mysqli_query($db, $sql_command);

    while($id_rows = mysqli_fetch_assoc($myresult))
    {
        $orderid = $id_rows['order_id'];
