...
<div class = "container center" style="width: 550px">
     ...
     <div id="idHelp" class="form-text">Below you see the id and type of the payment. Choose one of them to delete.</div>
...
<form action ="./deletion_pay.php" method="POST">
<select name="ids">


<?php

$sql_command = "SELECT payment_id, type FROM payment";

$myresult = mysqli_query($db, $sql_command);

    while($id_rows = mysqli_fetch_assoc($myresult))
    {
        $payid = $id_rows['payment_id'];
        $paytype = $id_rows['type'];
        
        echo "<option value=$payid>". $payid . " - " . $paytype . "</option>";
