...
{
    $supid = $_POST['ids'];
    $sql_statement = "DELETE FROM ticket_cus WHERE sup_id = $supid";
    $result = mysqli_query($db, $sql_statement);
   
    echo "<div class='card' style='width: 1060px'>";
    echo "<div class='card-body'>";
    echo "Message with ID: ". $supid . " is successfully deleted.";
    echo "</div>";
    echo "</div>";
    ...
    echo "</form>";
    echo "<form action='/ecommerce/deletion_ticket_cus_select.php' method='get'>";
    echo "<button type='submit' class='btn btn-warning' formaction='/ecommerce/deletion_ticket_cus_select.php'>Delete Again</button>";
    echo "</form>";
}

?>

<h1>Message list without deleted one.</h1>
<?php
