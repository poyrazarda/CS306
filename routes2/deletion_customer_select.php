...
<div class = "container center" style="width: 550px">
     ...
     <div id="idHelp" class="form-text">Below you see the id and name of the customer. Choose one of them to delete.</div>
...
<form action ="./deletion_customer.php" method="POST">
<select name="ids">


<?php

$sql_command = "SELECT customer_id, name FROM customer";

$myresult = mysqli_query($db, $sql_command);

    while($id_rows = mysqli_fetch_assoc($myresult))
    {
        $customerid = $id_rows['customer_id'];
        $customername = $id_rows['name'];
